  ...
  return (
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div id='customer-error' role='alert' aria-live="polite" aria-atomic="true">
        ...
        <div id='invoice-error' role='alert' aria-live="polite" aria-atomic="true">
          {state.errors?.amount &&
        ...
        <fieldset>
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
            <div className="flex gap-4">
              ...
              <div id='status-error' role='alert' aria-live="polite" aria-atomic="true">
                {state.errors?.status &&
